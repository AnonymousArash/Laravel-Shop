...
<input id="name" type="text" style="border:1px solid #eeeff1;font-size:13px;height:30px;width:250px;margin-top:20px;padding-right:5px;font-family:Yekan;margin-left:0px;" name="email" value="{{ old('email') }}">
</td>
