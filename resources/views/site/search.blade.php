...
<div class="menu_box" style="margin-top:20px;">
         ...
         <div>
          ...
          <tr>
          <td><input type="text" name="search_text" class="input" style="width:350px; height:30px;padding-right:5px;" value="{{ $text }}" placeholder="کلمه مورد نظر ..."></td>
          <td><input type="submit" style="margin-right:10px;margin-top:30px;margin-bottom:20px;" value="جست و جو" ></td>
          </tr>
...
{{ $Product->appends(['search_text'=>$text])->render() }}
