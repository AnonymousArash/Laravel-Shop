...
class Captcha
{
	public function create()
	{
        ...
        $image=imagecreatefrompng('resources/images/captcha.png');

        $font1='resources/fonts/'.rand(1,5).'.ttf';
        $font2='resources/fonts/'.rand(1,5).'.ttf';
        $font3='resources/fonts/'.rand(1,5).'.ttf';
        $font4='resources/fonts/'.rand(1,5).'.ttf';
        $font5='resources/fonts/'.rand(1,5).'.ttf';
